$(function() {
  ...
  const getBG = chrome.extension.getBackgroundPage(), url = document.getElementById("websiteURL");
  const timeUnit = document.getElementById("timeUnits"), time = document.getElementById("blockPeriod"), getReason = document.getElementById("comment");;
  var Data = Array(); 
